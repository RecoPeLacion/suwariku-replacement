...
プライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
		...
		<div class="suwarikuPrivacyPolicyMainDescribeText">
			<dl>
				<dt>第1条（個人情報）</dt>
			...
			<dl>
				...
				<dd>当社が個人情報を収集・利用する目的は、以下のとおりです。<br>当社サービスの提供・運営のため
...
上記の利用目的に付随する目的</dd>
			...
			<dl>
				<dt>第4条（利用目的の変更）</dt>
				<dd>当社は、利用目的が変更前と関連性を有すると合理的に認められる場合に限り、個人情報の利用目的を変更するものとします。<br>利用目的の変更を行った場合には、変更後の目的について、当社所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。</dd>
			</dl>
			<dl>
...
住所：長野県諏訪市豊田1070番地<br>
社名：株式会社スワリク<br>
担当部署：経理部<br>
Eメールアドレス：info@suwariku.co.jp</dd>
			</dl>
		</div>
	</div>
</section>
