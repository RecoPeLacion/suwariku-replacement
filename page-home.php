...
<main class="suwarikuContainer">
  ...
  <!-- end of mv -->
  <!-- company -->
  <section class="suwarikuHomeCompany suwarikuJsHomeAnimaItem">
    <div class="suwarikuContent">
      <div class="suwarikuHomeContent">
        ...
        <h3 class="suwarikuText36 suwarikuFontB suwarikuAlignC suwarikuJsHomeAnimaItem">これまでの50年、これからの50年</h3>
        <p class="suwarikuMt suwarikuText18 suwarikuAlignC suwarikuAlignCPc suwarikuTextLhl suwarikuJsHomeAnimaItem"> スワリクはおかげさまで令和4年に創立50周年を迎える事が出来ました。<br class="suwarikuPconly">これもひとえにお取引先様をはじめ関係者の皆様のおかげであると心から感謝申し上げます。<br class="suwarikuPconly"> そして何より従業員の皆さんとそのご家族の方々の支えがあったからこそ<br> 今日のスワリクが存在しております。<br>私達はこれまでの50年に感謝し、そしてこれからの50年も皆様の暮らしを守るため、<br class="suwarikuPconly">社業に専念してまいります。</p> <a href="<?php bloginfo('url'); ?>/about/#a-greeting" class="suwarikuMtxl Suwarikubtn">代表挨拶</a> </div>
    </div>
  </section>
  <!-- end of company -->
  <!-- history -->
  <section class="suwarikuHomeHistory suwarikuJsHomeAnimaItem">
    ...
    <div class="suwarikuInner">
      <div class="suwarikuHomeHistoryContent">
        ...
        <!--<a href="<?php //bloginfo('url'); ?>/history/" class="suwarikuMtl Suwarikubtn">スワリクの歩みを見る</a> --></div>
    </div>
  </section>
  <!-- end of history -->
  <!-- for recruit -->
  <section class="suwarikuHomeRecruit suwarikuJsHomeAnimaItem">
    <div class="suwarikuContent">
      <div class="suwarikuMt3xl suwarikuHomeContent">
        ...
        <p class="suwarikuText18 suwarikuTextLhl suwarikuAlignC suwarikuMtl suwarikuAlignCPc suwarikuJsHomeAnimaItem">スワリクの考え方は、創業以来から変わらない社員一人一人を大切に思い、<br class="suwarikuPconly">家族主義のような関係で仲間を思いやることを大切にしています。<br>社員という大切な財産が、一歩ずつ成長し幸せに成ることを願い、<br class="suwarikuPconly">個性を生かしていく人材育成に努め、適材適所の労働環境を提供していきます。<br class="suwarikuPconly">社員の皆さんがいてくれるからこそ会社が存続できることに感謝し、<br class="suwarikuPconly">会社の更なる成長のために共に、”良い会社”を創りましょう！！</p> <a href="recruit/" class="suwarikuMtxl Suwarikubtn">採用情報を見る</a> </div>
    </div>
  </section>
  <!-- end of recruit -->
  <!-- for service -->
  <section class="suwarikuHomeService">
    <div class="suwarikuContent">
      ...
      <section class="suwarikuMtxl suwarikuJsHomeAnimaItem">
  ...
  <!-- end of service -->
  <!-- information -->
  <section class="suwarikuHomeInformation suwarikuJsHomeAnimaItem">
      ...
      <div class="suwarikuHomeTopicsBox">
        <ul class="suwarikuHomeInformationList suwarikuJsHomeAnimaItem">
          ...
          <li class="suwarikuHomeInformationListItem"><a href="<?php echo the_permalink();?>">
              ...
              <p class="suwarikuText18 suwarikuLinkText"><?php echo wp_trim_words( get_the_title(), 26 , '…' ); ?></p></a>
          </li>
          <?php endwhile; ?>
          <?php endif?>
        </ul>
        <a href="<?php bloginfo('url'); ?>/information/" class="suwarikuMtl Suwarikubtn">一覧はこちら</a>
      </div>
    </div>
  </section>
  <!-- end of information -->
