...
<main class="l-container">
	...
	<div class="m-breadcrumb-wrap">
		<ol class="m-breadcrumb">
			...
			<li class="m-breadcrumb__item">神奈川営業所</li>
		</ol>
	</div>

	<section>
		<div class="l-inner m-pt-l m-pb-l tr-main-img">
			<h2 class="m-mt-xl m-line-title trans-pa"><span class="title">神奈川営業所</span></h2>
		...
		<div class="l-inner m-pt-l m-pb-l">
			...
			<div class="greeting-box trans-pa">
				...
				<div class="greeting-box_txt">
					...
					<p class="greeting-box_txt__name">所長 センター長　林 政仁</p>
				</div>
			</div>
			<p class="m-text-24 m-text-lh-l m-font-serif m-align-c m-align-c--pc">
				大手スーパー様、ドラックストアー様、<br class="m-pc-only">外食店様の納品センターとして365日、24時間活動しています！！
			</p>
		</div>
	</section>
	<section>
		<div class="l-inner m-pt-l m-pb-l">
			<h3 class="m-service-warehouse-item-title m-font-b m-text-30">物流（座間）</h3>
			<div class="kanagawa-box">
				<div class="kanagawa-box_img">
					<img src="<?php echo get_template_directory_uri(); ?>/resources/images/transportion/kana_img-01.png">
				</div>
				<div class="kanagawa-box_txt">
					<p>
			...
			<h3 class="m-service-warehouse-item-title m-font-b m-text-30">運行（相模原）</h3>
			<div class="kanagawa-box">
				<div class="kanagawa-box_img">
